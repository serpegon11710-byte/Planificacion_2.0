...
- Permite configurar planificación Puntual, Periódica o No planificado
...
13. Sistema muestra resumen completo:
    ...
    - Planificación: [tipo configurado]
...
- Planificación creada vinculada al item (configurada o "No planificado")

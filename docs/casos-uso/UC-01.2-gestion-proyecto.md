...
3. Sistema recorre **todas** las planificaciones de **todos** los items del proyecto y detecta bloqueos por RE-3 (Completada) y/o RE-4 (ocurrencias materializadas)
...
| Ocurrencias gestionadas | RE-4 | Anular o restaurar en gestión por planificación (UC-02.4) |
...
3. Ejemplo orientativo:
   ...
   > • Proyecto «Marketing 2026» · Item «Campaña Q1» · Semanal · «Reunión semanal» · 01/03/2026–31/12/2026 · 10:00 — Completada
...
No se puede eliminar un proyecto si alguna de sus planificaciones está Completada (RE-3) o tiene ocurrencias materializadas (RE-4). Objetivo: evitar borrados masivos accidentales. El usuario debe revertir manualmente con UC-01.4 y UC-02.4 antes de reintentar.

...
5. Si NO es el último item: sistema recorre **todas** las planificaciones del item y detecta bloqueos por RE-3 y/o RE-4
...
3. Ejemplo orientativo:
   ...
   > • Proyecto «Marketing 2026» · Item «Campaña Q1» · Mensual · «Informe mensual» · 01/01/2026–31/12/2026 · 08:00 — 3 ocurrencias gestionadas
...
No se puede eliminar un item si alguna de sus planificaciones está Completada (RE-3) o tiene ocurrencias materializadas (RE-4). Objetivo: evitar borrados masivos accidentales. El usuario debe revertir manualmente con UC-01.4 y UC-02.4 antes de reintentar.

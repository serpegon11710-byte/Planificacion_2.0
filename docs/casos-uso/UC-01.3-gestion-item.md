...
Permite al usuario crear nuevos items dentro de un proyecto o modificar items existentes. Al crear un item, el sistema automáticamente crea una planificación "No planificado" asociada.
...
flowchart TD
   ...
   D --> E[Persistir item]
   E --> F[Crear planificacion No planificado]
...
### Creación de Item
- **Creación automática de Planificación:** Cada item nuevo genera una planificación "No planificado"
...
7. **Sistema crea automáticamente una Planificación "No planificado"**
...
5. Si NO es el último item: Sistema muestra confirmación: "¿Eliminar item '{nombre}'? Esto eliminará también todas sus planificaciones"
6. Usuario confirma
7. Sistema elimina el item y todas sus planificaciones relacionadas (cascada)
8. Sistema muestra confirmación
...
Un item siempre debe tener al menos una planificación. La planificación automática "No planificado" cumple este requisito.

### RN-3.5: Eliminación en Cascada
Al eliminar un Item, se eliminan automáticamente:
...
- Sistema crea registro de Planificación "No planificado" directamente en BD

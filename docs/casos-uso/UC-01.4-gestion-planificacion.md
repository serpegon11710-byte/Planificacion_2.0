...
### FA-4: Planificación con ocurrencias materializadas (paso 4 de Eliminar)
1. Sistema detecta al menos una fila en `OcurrenciasMaterializadas` (modificada o eliminada virtualmente)
...
### RN-4.4: No eliminar planificación con ocurrencias materializadas
No se puede eliminar una planificación si existe al menos un registro en `OcurrenciasMaterializadas` vinculado, independientemente de si la ocurrencia está modificada o marcada como `eliminada_virtual`. El usuario debe usar **UC-02.4** para anular cada modificación o restaurar cada eliminación virtual hasta vaciar los registros físicos (RE-4, RC-6).

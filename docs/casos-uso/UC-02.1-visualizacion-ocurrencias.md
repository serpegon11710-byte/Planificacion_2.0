...
3. Sistema obtiene planificaciones planificadas aplicables al rango (excluye tipo "No Planificado").
...
### RN-2.1.4: Exclusión de planificaciones de tipo "No Planificado"
Las planificaciones de tipo "No Planificado" no forman parte del resultado de este caso de uso.
